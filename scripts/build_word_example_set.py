...
VISUAL_BENCHMARK=resolve_recorded(ROOT, "operator_review/req-ppaug-030-see-benchmark/pilot-see-v4/outputs/card_1024x1536.png")
LANGUAGE_BENCHMARK=resolve_recorded(ROOT, "operator_review/req-ppaug-030-see-benchmark/printed-see-languages-reference.png")
