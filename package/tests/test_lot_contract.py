...
from hypertext.lots.rules import (CHAPTER_LETTERS, IMAGE_DIMENSIONS, OPPONENT_LETTERS,
                                  OWNER_LETTERS, PAGE_VALUE, POINTS, VISITOR_LETTERS,
