...
def classify(text: str) -> dict[str, Any]:
    ...
    core = _first([
        ...
        ("mill_take", r"\bput the top \w+ cards of the Tower into Sheol, then add one of those cards\b"),
        ...
        ("look_take", r"\b(?:look at|reveal) (?:the )?(?:top|bottom|one card from the top)\b.*\badd (?:one|up to one)(?: of those cards| of those cards that [^.;]*| revealed card of the named type)? to your hand\b|\blook at one card from the top of the Tower and one card from the bottom of the Tower\. Add one of those cards"),
